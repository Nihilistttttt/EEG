...
static void ADS1299_Register_Init (void) {
    ...
    ADS1299_WriteReg (ADS1299_REG_BIAS_SENSP, ADS1299_BIAS_SENSP_CH1TO4);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_BIAS_SENSN, ADS1299_BIAS_SENSN_CH1TO4);
    Delay_Ms (10);
    ...
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH5SET, ADS1299_CHSET_POWER_DOWN);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH6SET, ADS1299_CHSET_POWER_DOWN);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH7SET, ADS1299_CHSET_POWER_DOWN);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH8SET, ADS1299_CHSET_POWER_DOWN);
    Delay_Ms (10);
}
