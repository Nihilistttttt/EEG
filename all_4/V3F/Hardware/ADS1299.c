...
/* ���������� */
#define RING_BUF_SIZE 64 /* ���λ�������ȣ�֡���� */
#define FRAME_SIZE ADS1299_FRAME_BYTE_NUM    /* ADS1299 ���������� 8 ͨ��֡��3 + 8*3 = 27 �ֽ� */
...
static volatile uint8_t head = 0; /* д�������ж����޸ģ� */
static volatile uint8_t tail = 0; /* ����������ѭ���޸ģ� */
...
static void ADS1299_Register_Init (void) {
    ...
    /* 5. BIAS ���� */
    ADS1299_WriteReg (ADS1299_REG_BIAS_SENSP, 0xFF);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_BIAS_SENSN, 0xFF);
    Delay_Ms (10);
    ...
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH5SET, 0x60);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH6SET, 0x60);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH7SET, 0x60);
    Delay_Ms (10);
    ADS1299_WriteReg (ADS1299_REG_CH8SET, 0x60);
    Delay_Ms (10);
}
