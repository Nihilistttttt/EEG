...
static int32_t ICM42605_AngleNumeratorToDeg10(int64_t numerator);
...
static int64_t icm42605_angle_x_numerator = 0;
static int64_t icm42605_angle_y_numerator = 0;
static int64_t icm42605_angle_z_numerator = 0;
...
static int32_t ICM42605_AngleNumeratorToDeg10(int64_t numerator)
{
    ...
    return (int32_t)(numerator / ICM42605_ANGLE_DEN);
}
...
static void ICM42605_UpdateAngleFromRaw(const ICM42605_RawData *raw)
{
    ...
    gyro_x = (int32_t)raw->gyro_x - icm42605_gyro_offset_x;
    gyro_y = (int32_t)raw->gyro_y - icm42605_gyro_offset_y;
    gyro_z = (int32_t)raw->gyro_z - icm42605_gyro_offset_z;
    ...
    icm42605_angle_x_numerator +=
        (int64_t)gyro_x * ICM42605_ANGLE_NUM_PER_LSB;
    icm42605_angle_y_numerator +=
        (int64_t)gyro_y * ICM42605_ANGLE_NUM_PER_LSB;
    icm42605_angle_z_numerator +=
        (int64_t)gyro_z * ICM42605_ANGLE_NUM_PER_LSB;
