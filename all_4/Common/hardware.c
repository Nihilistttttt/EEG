...
/* ================= Original hardware mode selection ================= */
#define MODE_FLASH_PROGRAM   0
#define MODE_EEG_ANALYSIS    1
#define MODE_SPI_TEST        2
#define MODE_MPU6050_TEST    3
...
#if (SYSTEM_MODE == MODE_FLASH_PROGRAM)
    Flash_Program_Mode();

#elif (SYSTEM_MODE == MODE_EEG_ANALYSIS)
...
#elif (SYSTEM_MODE == MODE_MPU6050_TEST)
    Serial_Init(SERIAL_PORT_DEBUG);
    while (1) {
        Serial_SendString(SERIAL_PORT_DEBUG, "hello\r\n");
    }
